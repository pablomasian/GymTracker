...
class NotBlockedExceptionTest {
	...
	void testConstructorAndGetters() {
		...
		NotBlockedException exception = new NotBlockedException(blockerId, blockedId);
	...
	void testGettersReturnCorrectValues() {
		NotBlockedException exception = new NotBlockedException(100L, 200L);
